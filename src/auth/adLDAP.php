...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@GDS.org";
    ...
    * @var string
    */
	protected $_base_dn = "DC=GDS,DC=org"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("s12.GDS.org");
    ...
    * @var string
    */
	protected $_ad_username=altiris;
    protected $_ad_password=t3ll3r;
